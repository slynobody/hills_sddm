...
Item {
    ...
    FastBlur {
        id: wallpaperBlur
        anchors.fill: parent
        radius: 96 * wallpaperFader.factor
       // samples : 24
    ...
    ShaderEffect {
        ...
        readonly property real contrast: 9.95 * wallpaperFader.factor + (1 - wallpaperFader.factor)
        readonly property real saturation: 0.80 * wallpaperFader.factor + (1 - wallpaperFader.factor)
        readonly property real intensity: (wallpaperFader.lightBackground ? 0.6 : 0.2) * wallpaperFader.factor + (1 - wallpaperFader.factor)
