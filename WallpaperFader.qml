...
Item {
    ...
    FastBlur {
        id: wallpaperBlur
        anchors.fill: parent
        radius: 20 * wallpaperFader.factor
    }
    ShaderEffect {
        id: wallpaperShader
        anchors.fill: parent
        ...
        readonly property real contrast: 0.95 * wallpaperFader.factor + (1 - wallpaperFader.factor)
        readonly property real saturation: 0.80 * wallpaperFader.factor + (1 - wallpaperFader.factor)
        readonly property real intensity: (wallpaperFader.lightBackground ? 2.9 : 0.7) * wallpaperFader.factor + (1 - wallpaperFader.factor)
